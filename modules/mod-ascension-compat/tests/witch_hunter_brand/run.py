...
def main():
    ...
    path = 'modules/mod-ascension-compat/src/AscensionWitchHunterAbilities.cpp'
    source = (subprocess.check_output(['git', 'show', f'{args.before}:{path}'], cwd=ROOT).decode()
    ...
    header = (ROOT / 'modules/mod-ascension-compat/src/AscensionWitchHunterCompletion.h').read_text()
