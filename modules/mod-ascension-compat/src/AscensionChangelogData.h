// Generated by Tools/Audit-LocalChangelog.py from the reviewed manifest; do not edit.
// 20260831-coa-changelog-v1; source IDs refer to Archive/changelog/changelog.jsonl.
//
// Hand edit, 2026-09-20: two entries retired because the 2026-09-19 client Spell.dbc
// now ships the change itself. This table replays upstream balance changes the client
// data had not yet received, so an entry whose outcome is already in the data has no
// object; keeping it only produced a warning at every start-up. If the generator is
// re-run, it must not put them back without re-reading the records.
//   {520753, 71880, 27, Field::Duration, 1, 6, 228, 5000, 15000, 8}
//     Guise: the DETECT_STEALTH aura moved off 520753 (slot 1 is aura 4, DurationIndex 0)
//     onto the triggered 520791, whose DurationIndex is 8 = 15000 ms — the exact value
//     this entry was written to force. The tooltip follows: "for $520791d".
//   {805751, 71877, 21, Field::ForceMoveForward, 0, 6, 241, 1, 0, 0}
//     Twilight Frenzy: slot 0 is aura 4 instead of 241 (FORCE_MOVE_FORWARD), and both
//     tooltips were rewritten with it — "Can dodge and parry and move while active",
//     and the aura text no longer says "Cannot stop moving".
...
inline constexpr std::array<Change, 59> Changes =
{{
